package com.prigic.simpleschoolmeal.school
 ...
 */
    ...
    fun getMonthlyMenu(year: Int, month: Int): List<SchoolMenu>? {
        ...
        try {
            var content =
                getContentFromUrl(URL(targetUrl.toString()))
            content = Utils.before(
                Utils.after(
                    content,
                    "<tbody>"
                ), "</tbody>"
